...
const nicheTemplateMap: Record<string, NicheTemplate> = {
  "salão de beleza": {
    ...
    reviews: [
      ...
      { name: "Fernanda S.", text: "Melhor salão de ${city}! Atendimento rápido e profissional. Voltarei sempre.", rating: 5 },
  ...
  "barbearia": {
    ...
    reviews: [
      { name: "Ricardo L.", text: "Cortei e fiz a barba em 40 min. Melhor barbearia de ${city}!", rating: 5 },
  ...
  "estética": {
    ...
    reviews: [
      ...
      { name: "Renata C.", text: "Resultado natural, exatamente como eu queria. A melhor de ${city}!", rating: 5 },
  ...
  "clínica odontológica": {
    ...
    reviews: [
      ...
      { name: "Patrícia A.", text: "O melhor dentista de ${city}. Atendimento rápido e resultado perfeito.", rating: 5 },
    ],
    reviewCount: 203,
  ...
  "fisioterapia": {
    ...
    reviews: [
      ...
      { name: "Marcos V.", text: "Melhor fisioterapeuta de ${city}. Recomendo de olhos fechados!", rating: 5 },
    ],
    reviewCount: 64,
  ...
  "oficina mecânica": {
    ...
    reviews: [
      ...
      { name: "Paulo C.", text: "Orçamento justo e serviço rápido. A melhor mecânica de ${city}.", rating: 5 },
  ...
  "baterias": {
    ...
    services: [
      ...
      { title: "Entrega em 40 Minutos", desc: "Entrega expressa em ${city} e região. Não espere, chame agora." },
    ],
    reviews: [
      { name: "João V.", text: "Carro parou na rua e em 30 minutos já estava com bateria nova. Incrível!", rating: 5 },
      { name: "Eduardo M.", text: "Melhor preço e entrega mais rápida de ${city}. Recomendo demais!", rating: 5 },
  ...
  "restaurante": {
    ...
    services: [
      ...
      { title: "Delivery Rápido", desc: "Entrega em ${city} com embalagem que mantém a qualidade. Peça agora." },
    ],
    reviews: [
      { name: "Ana C.", text: "Comida maravilhosa e entrega super rápida! Melhor restaurante de ${city}.", rating: 5 },
  ...
  "hamburgueria": {
    ...
    services: [
      ...
      { title: "Combos com Desconto", desc: "Hambúrguer + batata + bebida. Melhor custo-benefício de ${city}." },
      { title: "Delivery Express", desc: "Entrega rápida em ${city}. Chega quente na sua casa." },
    ],
    reviews: [
  ...
  "marmitaria": {
    ...
    services: [
      ...
      { title: "Entrega no Trabalho", desc: "Entrega pontual no horário do almoço em ${city}. Peça pelo WhatsApp." },
    ],
    reviews: [
      { name: "Alessandra M.", text: "Peço todo dia e sempre chega quente e no horário. Comida caseira de verdade!", rating: 5 },
      { name: "Bruno T.", text: "Porção generosa e preço justo. Melhor marmita de ${city}!", rating: 5 },
  ...
  "academia": {
    ...
    reviews: [
      ...
      { name: "Larissa K.", text: "Melhor academia de ${city}! Ambiente motivador e preço justo.", rating: 5 },
  ...
  "imobiliária": {
    ...
    reviews: [
      ...
      { name: "Carlos E.", text: "Processo rápido e sem dor de cabeça. A melhor imobiliária de ${city}.", rating: 5 },
    ...
    ctaText: "Chamar no WhatsApp agora",
    whatsappMessage: (company) => `Olá! Encontrei o site da ${company} e tenho interesse em imóveis em ${city}. Pode me mostrar opções?`,
    nameSuffix: "Imóveis",
  ...
  "contabilidade": {
    ...
    reviews: [
      ...
      { name: "Pedro H.", text: "O melhor contador de ${city}. Resolvem tudo rápido e sem enrolação.", rating: 5 },
    ],
    reviewCount: 92,
